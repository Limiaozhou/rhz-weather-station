...
typedef enum
{
  ...
  /**
    ...
    */
  /* --EV5 */
  I2C_EVENT_MASTER_MODE_SELECT               = (uint)0x0301,  /*!< BUSY, MSL and SB flag */
  ...
  /**
    ...
    */
  /* --EV6 */
  I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED = (uint)0x0782,  /*!< BUSY, MSL, ADDR, TXE and TRA flags */
  I2C_EVENT_MASTER_RECEIVER_MODE_SELECTED    = (uint)0x0302,  /*!< BUSY, MSL and ADDR flags */
  /* --EV9 */
  I2C_EVENT_MASTER_MODE_ADDRESS10            = (uint)0x0308,  /*!< BUSY, MSL and ADD10 flags */
  ...
  /* --EV7 */
  I2C_EVENT_MASTER_BYTE_RECEIVED             = (uint)0x0340,  /*!< BUSY, MSL and RXNE flags */
 
  /* Master TRANSMITTER mode --------------------------*/
  /* --EV8 */
  I2C_EVENT_MASTER_BYTE_TRANSMITTING         = (uint)0x0780,  /*!< TRA, BUSY, MSL, TXE flags */
  /* --EV8_2 */
 
  I2C_EVENT_MASTER_BYTE_TRANSMITTED          = (uint)0x0784,  /*!< EV8_2: TRA, BUSY, MSL, TXE and BTF flags */
  ...
  I2C_EVENT_SLAVE_RECEIVER_ADDRESS_MATCHED    = (uint)0x0202,  /*!< BUSY and ADDR flags */
  I2C_EVENT_SLAVE_TRANSMITTER_ADDRESS_MATCHED = (uint)0x0682,  /*!< TRA, BUSY, TXE and ADDR flags */
 
  /* 2) Case of General Call enabled for the slave */
  I2C_EVENT_SLAVE_GENERALCALLADDRESS_MATCHED  = (uint)0x1200,  /*!< EV2: GENCALL and BUSY flags */
  ...
  /* Slave RECEIVER mode --------------------------*/
  /* --EV2 */
  I2C_EVENT_SLAVE_BYTE_RECEIVED              = (uint)0x0240,  /*!< BUSY and RXNE flags */
  /* --EV4  */
  I2C_EVENT_SLAVE_STOP_DETECTED              = (uint)0x0010,  /*!< STOPF flag */
 
  /* Slave TRANSMITTER mode -----------------------*/
  /* --EV3 */
  I2C_EVENT_SLAVE_BYTE_TRANSMITTED           = (uint)0x0684,  /*!< TRA, BUSY, TXE and BTF flags */
  I2C_EVENT_SLAVE_BYTE_TRANSMITTING          = (uint)0x0680,  /*!< TRA, BUSY and TXE flags */
  /* --EV3_2 */
  I2C_EVENT_SLAVE_ACK_FAILURE                = (uint)0x0004  /*!< AF flag */
